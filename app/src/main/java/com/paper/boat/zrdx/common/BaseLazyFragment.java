...
//    }
     ...
     * startActivity 方法优化
     */
    public BaseLazyFragment <A> startActivity(Class cls) {
        mIntent = new Intent( mActivity, cls );
        return this;
    }

    public BaseLazyFragment <A> withObject(@Nullable String key, @Nullable Object value) {
        String json = GsonUtils.toJson( value );
        mBundle.putString( key, json );
        return this;
    }

    public BaseLazyFragment <A> withString(@Nullable String key, @Nullable String value) {
        mBundle.putString( key, value );
        return this;
    }

    public BaseLazyFragment <A> withDouble(@Nullable String key, @Nullable Double value) {
        mBundle.putDouble( key, value );
        return this;
    }

    public BaseLazyFragment <A> withBoolean(@Nullable String key, boolean value) {
        mBundle.putBoolean( key, value );
        return this;
    }

    public BaseLazyFragment <A> withInt(@Nullable String key, int value) {
        mBundle.putInt( key, value );
        return this;
    }

    public BaseLazyFragment <A> withFloat(@Nullable String key, float value) {
        mBundle.putFloat( key, value );
        return this;
    }

    public BaseLazyFragment <A> withIntegerArrayList(@Nullable String key, @Nullable ArrayList <Integer> value) {
        mBundle.putIntegerArrayList( key, value );
        return this;
    }

    public BaseLazyFragment <A> withStringArrayList(@Nullable String key, @Nullable ArrayList <String> value) {
