package com.paper.boat.zrdx.ui.actvity_utill;
 ...
 * ----------------------------------------------------------------------------------------------
 */
public class SelectPositionActiviy extends BaseActivity implements AMap.InfoWindowAdapter, AMap.OnInfoWindowClickListener, AMap.OnCameraChangeListener {
    private AMap aMap;
