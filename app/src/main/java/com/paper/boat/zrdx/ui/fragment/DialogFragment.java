    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_dialog_input:
                // 输入对话框
                new InputDialog.Builder( fActivity )
                        // 标题可以不用填写
                        .setTitle( "我是标题" )
                        // 内容可以不用填写
                        .setContent( "我是内容" )
            ...
            case R.id.btn_dialog_bottom_menu:
                ...
                // 底部选择框
                new MenuDialog.Builder( fActivity )
                        // 设置 null 表示不显示取消按钮
                        //.setCancel(getString(R.string.common_cancel))
                        // 设置点击按钮后不关闭对话框
                        //.setAutoDismiss(false)
            ...
            case R.id.btn_dialog_succeed_toast:
                // 成功对话框
                new ToastDialog.Builder( fActivity )
            ...
            case R.id.btn_dialog_wait:
                // 等待对话框
                final BaseDialog dialog = new WaitDialog.Builder( fActivity )
                        // 消息文本可以不用填写
            ...
            case R.id.btn_dialog_pay:
                // 支付密码输入对话框
                new PayPasswordDialog.Builder( fActivity )
            ...
            case R.id.btn_dialog_address:
                // 选择地区对话框
                new AddressDialog.Builder( fActivity )
            ...
            case R.id.btn_dialog_date:
                // 日期选择对话框
                new DateDialog.Builder( fActivity )
            ...
            case R.id.btn_dialog_time:  /*时间*/
                // 时间选择对话框
                new TimeDialog.Builder(fActivity)
            ...
            case R.id.btn_dialog_update: /*更新*/
                new UpdateDialog.Builder( fActivity )
                        // 版本名
            ...
            case R.id.btn_dialog_custom:
                // 自定义对话框
                new BaseDialogFragment.Builder( fActivity )
