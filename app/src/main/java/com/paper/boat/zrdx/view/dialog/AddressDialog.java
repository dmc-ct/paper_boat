...
import com.paper.boat.zrdx.ui.adapter.BaseRecyclerViewAdapter;
import com.paper.boat.zrdx.ui.adapter.MyRecyclerViewAdapter;
...
public final class AddressDialog {
    ...
    private static final class AddressDialogAdapter extends MyRecyclerViewAdapter <AddressBean> {
        ...
        @NonNull
        @Override
        public MyRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
