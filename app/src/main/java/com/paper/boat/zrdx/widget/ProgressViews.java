package com.paper.boat.zrdx.widget;
 ...
 *    desc   : 进度条控件
 */
public final class ProgressViews extends View {
    ...
    public ProgressViews(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ProgressViews);
        ...
        mCircleRadius = (int) array.getDimension(R.styleable.ProgressViews_circleRadius, mCircleRadius);
        mFillRadius = array.getBoolean(R.styleable.ProgressViews_fillRadius, false);
        mBarWidth = (int) array.getDimension(R.styleable.ProgressViews_barWidth, mBarWidth);
        mRimWidth = (int) array.getDimension(R.styleable.ProgressViews_rimWidth, mRimWidth);
        float baseSpinSpeed = array.getFloat(R.styleable.ProgressViews_spinSpeed, mSpinSpeed / 360.0f);
        mSpinSpeed = baseSpinSpeed * 360;
        mBarSpinCycleTime = array.getInt(R.styleable.ProgressViews_barSpinCycleTime, (int) mBarSpinCycleTime);
        mBarColor = array.getColor(R.styleable.ProgressViews_barColor, mBarColor);
        mRimColor = array.getColor(R.styleable.ProgressViews_rimColor, mRimColor);
        mLinearProgress = array.getBoolean(R.styleable.ProgressViews_linearProgress, false);
        if (array.getBoolean(R.styleable.ProgressViews_progressIndeterminate, false)) {
            spin();
        }
        array.recycle();
